...
namespace HangmanProject
{
    class Program
    {
        ...
        internal static void CompareLetter(char userChar, char[] wordAsArray)
        {
    ...
    /*Class Display
    {
        protected static string InputList = "";
        ...
        //Takes input and displays in row previous inputs
        //Place commented code below in Program.Main to demo InputDisplay method
        //
        //while (true)
        //    {
        ...
        //    }
    public static void InputDisplay(string input)
        {
            InputList += input + " ";
            Console.Clear();
